...
export function ImageUploadField({
  ...
  return (
    <label className="relative flex flex-col items-center justify-center gap-1 rounded-xl border border-dashed border-line py-6 text-sm text-muted cursor-pointer overflow-hidden min-h-24">
      {previewUrl ? (
      ...
      <span className="relative z-10 bg-surface/80 px-2 py-1 rounded">
